...
class Customers {
    ...
    Cnic: number
    balance: number = Math.floor(Math.random() * 90000)
    password: number 
    
    constructor(FullName: string, FatherName: string, Age: number, Gender: string, MobileNumber: number, Cnic: number, password: number) {
    ...
    checkPassword(inputPassword: number): boolean {
    ...
    changePassword(newPassword: number) {
    ...
    transferMoney(bank:string,TransferAccountNumber: number, amount: number) {
        if (amount > this.balance) {
            console.log(chalk.red.bold("\nInsufficient Balance\n"));
        } else {
            this.balance -= amount
...
class BankManager {
    ...
    addCustomer(FullName: string, FatherName: string, Age: number, Gender: string, MobileNumber: number, Cnic: number, password: number) {
    ...
    viewBalancee(AccountNumber: number, password: number) {
    ...
    CashWithdraw(AccountNumber: number, password: number, amount: number) {
        let CustomerAccountNumCheck = this.customers.find((cus) => cus.AccountNumber === AccountNumber)
    ...
    CashDeposit(AccountNumber: number, password: number, amount: number) {
        let CustomerAccountNumCheck = this.customers.find((cus) => cus.AccountNumber === AccountNumber)
    ...
    changePassword(AccountNumber: number, password: number, newPassword: number) {
        let CustomerAccountNumCheck = this.customers.find((cus) => cus.AccountNumber === AccountNumber)
    ...
    showDetails(AccountNumber: number, password: number) {
        let CustomerAccountNumCheck = this.customers.find((cus) => cus.AccountNumber === AccountNumber)
    ...
    transferMoney(AccountNumber: number, password: number ,bank:string, TansferAccountNum: number, amount: number) {
        let CustomerAccountNumCheck = this.customers.find((cus) => cus.AccountNumber === AccountNumber)
